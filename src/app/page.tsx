        ...
        <main className="py-16 md:py-36 text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg sm:text-xl mb-10 md:mb-12 max-w-3xl mx-auto text-muted-foreground">
              Streamline your procurement process. Connect with verified
              suppliers and access on bulk phone orders, accessories, and more.
            </p>
                  ...
                  <Card className="h-full flex flex-col justify-between">
                    ...
                    <CardContent className="pt-6 flex-grow">
                      ...
                      <CardDescription className="text-muted-foreground mb-4">
                        Unleash unparalleled power and a pro-grade camera
                        system.
                      </CardDescription>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap justify-center gap-8 max-w-6xl mx-auto">
              ...
              <Card className="text-center p-6 shadow-md hover:shadow-lg transition-shadow duration-300 group flex-none w-full sm:w-[calc(50%-1rem)] md:w-[calc(32%-0.5rem)] lg:w-[calc(32%-0.5rem)]">
                ...
                <CardContent>
                  <CardDescription>
                    Access a secure network of thoroughly vetted manufacturers
                    and distributors.
                  </CardDescription>
                </CardContent>
              </Card>
